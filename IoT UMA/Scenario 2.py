...
# Nodes have a randomized amount of RAM (between 0 and 2000 Mbs)
for x in range(0, nUsers):
	...
	nodes[x][4] = random.uniform(0,2000)
	nodes[x][5] = 1
...
nodes[nUsers + nMeshlium][4] = random.uniform(0,2000)
...
nodes[nUsers + nMeshlium + 1][4] = random.uniform(0,2000)
...
for x in range(nMeshlium + 2, nMeshlium +5):
	...
	nodes[nUsers + x][4] = random.uniform(0,2000)
